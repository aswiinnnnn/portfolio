...
const projects: Project[] = [
  {
    ...
    description: "Complete brand identity for a popular bakery chain including logo, packaging, and visual guidelines. A comprehensive system built for scale.",
    sector: "F&B",
    year: "2024",
    responsibility: "Logo & Visual Identity",
    color: "hsl(30 60% 35%)",
  ...
  },
  {
    ...
    description: "Full event collateral design — from gate arches to standies, invitations, and social media campaign materials with premium aesthetics.",
    sector: "Events",
    year: "2024",
    responsibility: "Event Branding",
    color: "hsl(280 40% 45%)",
    images: [p2_1, p2_2],
  },
  {
    ...
    description: "Product packaging series for organic produce line. Clean, minimal design system across 12 SKUs focusing on sustainability.",
    sector: "Retail",
    year: "2023",
    responsibility: "Packaging & Labels",
    color: "hsl(150 50% 30%)",
    images: [p3_1, p3_2],
  },
  {
    ...
    description: "Social media campaign for nightlife brand. Bold visuals, animated stories, and promotional materials designed for maximum engagement.",
    sector: "Entertainment",
    year: "2024",
    responsibility: "Campaign Creatives",
    color: "hsl(320 60% 45%)",
    images: [p4_1, p4_2],
  },
  {
    ...
    title: "Craft & Co",
    category: "Brand Identity",
    description: "Artisan brewery branding from ground up — logo, labels, merch, and taproom environmental graphics with a hand-crafted feel.",
    sector: "F&B",
    year: "2023",
    responsibility: "Full Branding",
    color: "hsl(45 70% 40%)",
    images: [p5_1, p5_2],
  },
  {
    ...
    description: "Minimalist interior design concept for high-end boutique apartments in urban centers.",
    sector: "Interiors",
    year: "2023",
    responsibility: "Concept Design",
    color: "hsl(210 20% 30%)",
    images: [p6_1, p6_2],
  },
  {
    ...
    title: "Art Gallery",
    category: "Brand Identity",
    description: "Minimalist branding for a contemporary art gallery, focusing on typography and spatial awareness.",
    sector: "Art & Culture",
    year: "2024",
  ...
  },
  {
    ...
    title: "Eco Pulse",
    category: "Digital Campaign",
    description: "Sustainability campaign for an eco-friendly tech start-up, using vibrant gradients and natural textures.",
    sector: "Tech",
    year: "2024",
    responsibility: "Digital Strategy",
    color: "hsl(120 40% 35%)",
    images: [p8_1, p8_2],
  },
];
